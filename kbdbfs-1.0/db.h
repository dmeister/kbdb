...
//#error Why in tarnation do you need this file in this directory?
 ...
 *
 * $Id: db.h,v 1.4 2003/12/21 02:22:32 hari Exp $
 *
...
#else
int db_env_set_func_fsync __P((int (*)(struct file *)));
#endif
#ifndef __KERNEL__
int db_env_set_func_ioinfo __P((int (*)(const char *, int, u_int32_t *, u_int32_t *, u_int32_t *)));
#else
int db_env_set_func_ioinfo __P((int (*)(const char *, struct file *, u_int32_t *, u_int32_t *, u_int32_t *)));
#endif
...
#else
struct file * db_env_set_func_open __P((struct file *(*)(const char *, int, ...)));
#endif
#ifndef __KERNEL__
int db_env_set_func_read __P((ssize_t (*)(int, void *, size_t)));
#else
int db_env_set_func_read __P((ssize_t (*)(struct file *, void *, size_t)));
#endif
...
#else
int db_env_set_func_seek __P((int (*)(struct file *, size_t, db_pgno_t, u_int32_t, int, int)));
#endif
...
#else
int db_env_set_func_write __P((ssize_t (*)(struct file *, const void *, size_t)));
#endif
...
#else
struct file *  __db_ndbm_dirfno __P((DBM *));
#endif
...
#else
struct file *	 __db_ndbm_pagfno __P((DBM *));
#endif
...
#endif
#ifdef __KERNEL__
typedef int (*__compar_fn_t) (__const void * a, __const void *b);
void kdb3_qsort (void *b, size_t n, size_t s, __compar_fn_t cmp);
int kdb3_stat(const char *filename, struct stat * statbuf); 
int kdb3_path_lookup(const char *path, unsigned flags, struct nameidata *nd);
#endif
...
#if defined __KERNEL__ && defined KERNEL_DEBUG
extern char * add_indent(void);
extern char *del_indent(void);
# define print_entry_location() printk("%sIN:  %s() %s:%d\n", add_indent(), __FUNCTION__, __FILE__, __LINE__)
# define print_exit_location(ret) printk("%s OUT: %s() %s:%d, ret=%d\n", del_indent(), __FUNCTION__, __FILE__, __LINE__, ret)
# define print_ret(ret) printk("%s %s %d ret=%d\n", __FUNCTION__, __FILE__, __LINE__, ret)
#endif /* defined __KERNEL__ && defined KERNEL_DEBUG */
